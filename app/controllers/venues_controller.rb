class VenuesController < ApplicationController
  def index
    ...
    @venues = @q.result(:distinct => true).includes(:date).page(params[:page]).per(10)
  ...
  def create
    ...
    @venue.street_address_1 = params[:street_address_1]
    @venue.street_address_2 = params[:street_address_2]
